...
edges = [[3, 5], [3, 16], [4, 7], [4, 8], [4, 13], [4, 16],
         [5, 10], [5, 14], [6, 17], [7, 9], [7, 10], [7, 14], [7, 15],
         [7, 17], [8, 9], [8, 14], [8, 17], [10, 11], [10, 13], [10, 16],
         [11, 15], [12, 14], [12, 15], [13, 14], [13, 15], [15, 16]]
...
print("\nДвудольный граф или биграф — это граф, множество вершин которого можно разбить на две части таким образом, чтобы каждое ребро графа соединяло какую-то вершину из одной части с какой-то вершиной другой части, то есть не существует ребра, соединяющего две вершины из одной и той же части.\n",
